...
import { clearApiKey, createChatSession, isAuthenticationError } from '../services/ai';
          ...
          setMessages([
            {
              id: 'error',
              role: 'model',
              text: 'Your saved API key is no longer valid. Please enter it again.',
            },
          ]);
          onResetKey?.();
        } else {
      ...
      <div className="w-full md:w-80 bg-blue-950 border-r border-blue-900 p-8 flex flex-col text-white">
        <div className="flex flex-col items-center text-center mb-10">
          <div className="relative mb-6">
            <img
              ...
              className="w-32 h-32 rounded-full bg-white shadow-sm border-4 border-blue-900/50 object-cover"
            />
            {isSpeaking && (
        ...
        <div className="space-y-4 flex-1">
          <div className="bg-blue-900/40 p-5 rounded-xl border border-blue-800/50 shadow-sm">
            <div className="text-xs text-blue-300 uppercase font-bold tracking-wider mb-2">
              Topic
            </div>
              ...
              <button
                ...
                className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg transition-colors ${
                  isListening
                    ...
                    : 'text-stone-400 hover:text-blue-950 hover:bg-stone-200'
                }`}
              >
                {isListening ? (
